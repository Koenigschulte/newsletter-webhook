...
TOPICS = {
    "ds": {
        ...
        "feeds": [
            ...
            ("de", "https://feeds.feedburner.com/heise/security"),
    ...
    "ki": {
        ...
        "keywords": [
            ...
            "eu ai act", "machine learning", "ki-modell", "generative",
            "transformer", "nvidia", "deepseek", "mistral", "meta llama",
            "ki-regulierung", "ki-gesetz", "silicon valley", "sam altman",
            "elon musk", "xai", "grok", "perplexity", "ki-chip", "ki-startup",
        ],
        "feeds": [
            ("de", "https://t3n.de/rss.xml"),
            ("de", "https://www.heise.de/rss/heise-atom.xml"),
            ("de", "https://www.golem.de/rss.php"),
